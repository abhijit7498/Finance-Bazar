...
const contactOptions = [
    {
        ...
        description: "For queries related to loans, credit cards or in case of any general enquiries",
    },
    {
    ...
    },
    {
        ...
        description: "You can even reach out to us via WhatsApp. Our service expert team will help you with your queries",
    },
];
...
const contactOptions2 = [
    {
        ...
        mailTo: "mailto:creditreport@financesbazar.com?subject=Help%20with%20Credit%20Report&body=Hi%20financesbazar%20team%2C%0A%0AI%20need%20support%20regarding%20my%20credit%20report.%20Please%20assist.%0A%0AThanks"
    },
    {
        id: 2,
        ...
        mailTo: "mailto:stepupcare@financesbazar.com?subject=Step%20Up%20Card%20Query&body=Hi%20financesbazar%2C%0A%0AI%20have%20a%20question%20regarding%20my%20Step%20Up%20Card%20or%20FD.%20Please%20help.%0A%0AThanks"
    },
    {
        id: 3,
        ...
        mailTo: "mailto:npsgrievanceofficer@financesbazar.com?subject=NPS%20Account%20Assistance&body=Dear%20financesbazar%20NPS%20Support%2C%0A%0AI%20need%20assistance%20regarding%20my%20NPS%20account.%20Please%20guide%20me.%0A%0ARegards"
    },
    {
        id: 4,
        ...
        mailTo: "mailto:mutualfunds@financesbazar.com?subject=Mutual%20Fund%20Support&body=Hello%2C%0A%0AI%20need%20some%20help%20with%20my%20mutual%20funds%20account%20or%20investment.%0A%0AThank%20you"
    }
];
        ...
        <PageLayout>
            <div className="max-w-6xl mx-auto px-6 lg:px-8 mt-12 grid gap-8 sm:gap-12">
                ...
                <div className="grid gap-6">
                    ...
                    <TypographyMuted>
                        In case your concern is not resolved, you can contact the levels and wait for a resolution as per the Turnaround-Time mentioned.
                    </TypographyMuted>
                            ...
                            <TableBody>
                                {grievanceLevels.map((option, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>{option.turnaroundTime}</TableCell>
                                        <TableCell>
                                            <div className="font-medium">Name: {option.name}</div>
                                            <div className="text-sm text-muted-foreground">Designation: {option.designation}</div>
                                        </TableCell>
                                        <TableCell className="grid gap-2">
                                            <div className="text-sm">Address: {option.address}</div>
