        ...
        <PageLayout>
            ...
            <div className="max-w-5xl mx-auto px-6 mb-8 sm:px-8">
                    ...
                    <Table className="border border-black mt-4">
                        ...
                        <TableBody>
                            {chunkedTopics?.map((row, rowIndex) => (
                                <TableRow key={rowIndex} className="opacity-95 text-blue-800 cursor-pointer border border-black">
                                    {row.map((topic, colIndex) => (
                                        <TableCell key={colIndex} className="border-l border-black">
                                            {topic}
                                        </TableCell>
                                    ))}
                                </TableRow>
                ...
                <>
                    ...
                    <img src="/assets/Adhar-card.jpeg" alt="adhar-card" className="sm:w-96 w-full" />
                </>
                ...
                <>
                    ...
                    <Table className="border border-black mt-4">
                        ...
                        <TableBody>
                            {chunkedTopics2?.map((row, rowIndex) => (
                                <TableRow key={rowIndex} className="opacity-95 text-blue-800 cursor-pointer border border-black">
                                    {row.map((topic, colIndex) => (
                                        <TableCell key={colIndex} className="border-l border-black">
                                            {topic}
                ...
                <>
                    ...
                    <Table className="border border-black mt-4">
                        ...
                        <TableBody>
                            {chunkedTopics3?.map((row, rowIndex) => (
                                <TableRow key={rowIndex} className="opacity-95 text-blue-800 cursor-pointer border border-black">
                                    {row.map((topic, colIndex) => (
                                        <TableCell key={colIndex} className="border-l border-black">
                                            {topic}
