...
export default function PersonalLoanApply() {
    ...
    const validateStep5 = () => {
        ...
        if (!formData.annualIncome || isNaN(formData.annualIncome)) newErrors.annualIncome = "Valid annual income is required.";
        if (!formData.loanAmount || isNaN(formData.loanAmount)) newErrors.loanAmount = "Valid loan amount is required.";
        if (!formData.currentEMI || isNaN(formData.currentEMI)) newErrors.currentEMI = "Valid EMI amount is required.";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-6 w-full sm:h-screen sm:overflow-y-hidden">
            ...
            <div className="bg-[#CAD7FE] sm:p-8 p-6 relative">
                ...
                <div className="max-w-lg mx-auto sm:mt-10 mt-4 relative">
                    ...
                    <div>
                        {/* <img src="/assets/personal-loan.gif" className="w-48"></img> */}
                    </div>
                </div>
            </div>
