import { Headline, TypographyMuted, TypographyH3, TypographySmall } from "@/custom/Typography";
...
const aboutDataCards = [
    {
        ...
        description: "Financesbazar is India’s largest digital consumer credit marketplace, offering wide choice and ease of comparison.",
    },
    {
        icon: <RiCustomerService2Fill size={36} className="text-accent" />,
        label: "40 Million+ Happy Customers",
        description: "More than 40 million Consumers from 823 cities across India have accessed their free credit score from Financesbazar.",
    },
    {
        icon: <PiMicrosoftTeamsLogoLight size={36} className="text-accent" />,
        label: "65+ Partnerships",
        description: "We work with top banks, NBFCs, fintech lenders and credit bureaus to offer a wide choice to consumers across segments.",
    },
];
...
const milestones = [
    {
        year: 2023,
        events: [
            { title: "Launches 3rd edition of insight report ‘Making India Credit Fit’", action: "See more from this year" }
        ]
    },
    {
        year: 2022,
        events: [
            { title: "Wins Best Fintech Consumer Lender at India Fintech Awards", action: "See more from this year" }
        ]
    },
    {
        year: 2021,
        events: [
            { title: "Wins ‘Outstanding Crisis Finance Innovation 2021 (Asia Pacific) Award’ by Global Finance Magazine", action: "See more from this year" }
        ]
    },
    {
        year: 2020,
    ...
    },
    {
        year: 2019,
        events: [
            { title: "Becomes the only independent digital platform to disburse USD 1 billion loans (annualized)", action: "See more from this year" }
        ]
    },
    {
        year: 2018,
        events: [
            { title: "Gets products applications from 1000 cities in a single month", action: "See more from this year" }
        ]
    },
    {
        year: 2017,
        events: [
            { title: "Wins Best Customer Experience Innovation at Moneytech Awards", action: "See more from this year" }
        ]
    },
    {
        year: 2016,
        events: [
            { title: "Wins ET \"Best Financial Services Brand\"", action: "See more from this year" }
        ]
    },
    {
        year: 2014,
