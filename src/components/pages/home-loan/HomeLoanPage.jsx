...
import { BoldList } from "../../../custom/Typography";
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 sm:gap-12">
                        <div className="sm:col-span-7">
                            ...
                            <TypographyMuted className="sm:mb-8 mb-4  leading-7">
                                Get a home loan at 7.90% p.a. onwards through Financesbazar for tenures of up to 30 years. Compare interest rates and loan features from top lenders and apply for the best home loan online.
                            </TypographyMuted>
                        </div>
