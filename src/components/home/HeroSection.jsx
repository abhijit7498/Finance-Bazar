...
const slides = [
  {
    id: 1,
    content: (
      <div className="flex justify-between sm:gap-8 gap-4 items-center w-full relative">
        {/* Text Section */}
        <div className="space-y-2 sm:space-y-6 order-2 sm:order-1 sm:text-left px-4 sm:px-0 max-w-md">
          ...
          <TypographyH4 className="text-xs sm:text-base opacity-65 flex items-center gap-2 justify-start">
          ...
          <Link to="/cibil-credit-report/apply">
  ...
  },
  {
    id: 2,
    content: (
      <div className="flex justify-between gap-4 sm:gap-8 sm:items-center w-full">
        {/* Image */}
        ...
        {/* Text */}
        <div className="space-y-2 sm:space-y-6 order-2 sm:order-2 sm:text-left px-4 sm:px-0 max-w-md">
          <h1 className="text-sm sm:text-3xl font-bold">
          ...
          <Button size="sm" className="mt-3 sm:px-6 cursor-pointer">
            Search Credit Card <FiArrowRight className="ml-2" />
          </Button>
        </div>
      </div>
    ),
    ...
    content: (
      <div className="flex justify-around gap-4 sm:mt-8 sm:gap-8 w-full">
        ...
        <div className="flex justify-end order-1 sm:order-1">
          <img src="/assets/personal-loan.png" alt="Personal loan" className="sm:w-48 w-38 relative sm:-top-10" />
        </div>
        ...
        <div className="space-y-2 sm:space-y-6 order-2 sm:order-2 px-4 sm:px-0 max-w-md">
          ...
          <Button size="sm" className="mt-3 sm:px-6 cursor-pointer">
            Get Any Loan <FiArrowRight className="ml-2" />
          </Button>
        </div>
      </div>
    ),
  ...
  return (
    <section className="bg-gradient-to-r from-[#f5f9ff] to-[#f0fdfa] overflow-hidden">
      <div className="max-w-6xl mx-auto p-6">
        {/* Slide Container */}
        <div className="relative min-h-[200px] sm:min-h-[400px] flex items-center justify-center">
