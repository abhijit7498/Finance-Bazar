            ...
            <div className="bg-[#CAD7FE] sm:p-8 p-6 relative">
                ...
                <div className="max-w-lg mx-auto sm:mt-10 mt-4 relative">
                    ...
                    <TypographyMuted className="mt-8 text-blue-900 leading-7">
                        Every business needs capital to grow and at Financesbazar, we ensure you get the best of what you need. Whether you are launching or expanding your business, we pledge to give you best business loan offers.
                    </TypographyMuted>
                </div>
