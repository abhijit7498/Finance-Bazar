    ...
    return (
        <div className="border-t-2 mt-4" id={id}>
            <div
                ...
                onClick={handleClick}
            >
                <TypographyH4BlueColor className="mt-0 font-light">{title}</TypographyH4BlueColor>
            ...
            >
                <div className={isOpen ? "pb-4 opacity-100 transition-opacity duration-300" : "opacity-0 transition-opacity duration-300"}>
                    {children}
                </div>
            </div>
        </div>
        ...
        <>
            ...
            <div className='w-fit border border-black bg-gray-100 mt-4 p-3'>
                ...
                <div className='grid gap-3 mt-3'>
                    {
                        sbiCardSections?.map((option, index) => (
                            <a
                                key={index}
                                href={option?.link}
                ...
                <Table className="border border-black mt-2">
                    <TableHeader>
                        <TableRow className="border border-black">
                            <TableHead className="border-r border-black font-semibold">SBI Credit Card</TableHead>
                            <TableHead className="border-r border-black font-semibold">Annual Fee</TableHead>
                            <TableHead className="font-semibold">Best Suited For</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {sbiCardsData.map((card, index) => (
            ...
            >
                ...
                <Table className="border mt-6 border-black">
                    <TableHeader>
                        <TableRow className="border border-black">
                            <TableHead className="border-r text-center border-black font-semibold">Fee Type</TableHead>
                            <TableHead className="font-semibold text-center">Amount</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {sbiFeeStructure.map((fee, index) => (
                            <TableRow key={index} className="border border-black">
                                <TableCell className="border-r text-blue-950 font-semibold border-black whitespace-pre-wrap">
                                    {fee.feeType}
                                </TableCell>
                                <TableCell className="whitespace-pre-wrap text-gray-700">{fee.amount}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
            ...
            >
                ...
                <Table className="border border-black mt-2">
                    ...
                    <TableBody>
                        {Array.from({ length: Math.ceil(sbiCreditCardLinks.length / 3) }, (_, rowIndex) => {
                            const rowItems = sbiCreditCardLinks.slice(rowIndex * 3, rowIndex * 3 + 3);
                            return (
