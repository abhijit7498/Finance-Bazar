    ...
    return (
        <div className="border rounded-md overflow-hidden">
            <div className="grid grid-cols-1 sm:grid-cols-12 sm:gap-4 border-b">
                {/* Card Image */}
                <div className="flex flex-col bg-gray-100 p-4 sm:p-6 sm:col-span-3">
                ...
                <div className="flex flex-col gap-3 p-4 sm:col-span-9">
                    ...
                    <div className="flex flex-wrap gap-8 text-sm text-gray-600">
                        <div>
                            <span className="font-medium text-black">Joining fee:</span> {joiningFee}
                        </div>
                        <div>
                            <span className="font-medium text-black">Annual/Renewal Fee:</span> {annualFee}
                        </div>
                    </div>
            ...
            {showDetails && (
                <div className="p-4">
                    ...
                    <TypographyList2
                        className="mt-2 sm:ml-4 mb-2 text-xs sm:text-sm text-gray-800"
                        items={benefits}
                    />
