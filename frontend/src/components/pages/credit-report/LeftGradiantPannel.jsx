        ...
        <div className='sm:hidden flex flex-col w-full'>
            ...
            <div className='bg-[#E7F2E4] w-full flex justify-between py-6'>
                <div className='pl-4 basis-sm space-y-3'>
                    ...
                    {
                        mobileHeroheadlineList && <TypographyList items={mobileHeroheadlineList} className="text-muted-foreground mt-2 text-xs" />
                    }
                    {
                        features && (
                ...
                <div className='flex justify-end items-end'>
                    <img src={mobileHeroImeges} alt="credit-score" className='w-62' />
                </div>
            </div>
        </div>
    )
    ...
    return (
        <div className=" bg-[#E7F2E4] w-full h-screen sm:flex flex-col hidden overflow-hidden">
            <div className='max-w-md p-8'>
                ...
                >
                    <img src="/logo.png" alt="logo" className='w-38 h-fit' />
                </Link>
                <div className='mt-[25%] ml-[20%] w-full'>
                    ...
                    {
                        image && (
                            <img src={image} alt='photo' className='w-96' />
                        )
                    }
