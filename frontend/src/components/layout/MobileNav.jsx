...
import { TypographyH4, TypographyPBlueColor, TypographyP } from "@/custom/Typography";

export default function MobileNav({ mainNavItems, isSheetOpen, setIsSheetOpen }) {

  // Store open/close state for each dropdown
            ...
            {mainNavItems.map((item, index) =>
              item.isSingle ? (
                <div key={index}>
                  ...
                  <div className="px-4 py-4 border-t-2 my-4 ">
                    ...
                    <TypographyP className="text-[13px] text-blue-950 leading-5">
                      Our customer care team is available from <strong>Mon - Sat 9:30 am – 6:30 pm</strong> to assist you with the best offers, or help resolve any queries.
                    </TypographyP>
                    <TypographyP className="text-[13px] text-blue-950 mt-4">
                      You can call us on: <br />
                      <strong>+91 7709222331</strong><br />
                    </TypographyP>
                  </div>
                </div>
                ...
                <div key={item.title} className="space-y-2">
                  ...
                  >
                    <TypographyH4 className="text-[15px] text-[#183B4E]">{item.title}</TypographyH4>
                    <FiChevronDown
